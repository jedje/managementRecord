		...
		<div class="sidebar" data-color="white" data-active-color="danger">
			...
			<div class="sidebar-wrapper">
				<ul class="nav">
					...
					<li class="active"><a href="${pageContext.request.contextPath}/i/point?instructor_id=${sessionScope.login.instructor_id}"> <i
											...
											<div class="col-md-12">
												...
												<c:forEach var="due" items="${list4}">
														<tr>
															...
															<td><a href="${pageContext.request.contextPath}/i/point/info?instructor_id=${sessionScope.login.instructor_id}&os_id=${due.os_id}">
																<button type="button" 
																	class="btn btn-default btn-icon" title="조회">
																	<i class="fa fa-search-plus"></i>
																</button></a></td>
