	...
	<div class="wrapper ">
		<div class="sidebar" data-color="white" data-active-color="danger">
            ...
            <div class="logo">
				...
				<a class="simple-text logo-normal"> 관리자 [엄호선] </a>
			</div>
			...
			<div class="sidebar-wrapper">
				<ul class="nav">
					...
					<li class="active"><a href="${pageContext.request.contextPath}/a/oc"> <i
					...
					<li><a href="${pageContext.request.contextPath}/views/admin/a_password.jsp"> <i
							class="fa fa-gear"></i>
							관리자 계정 관리
					</a></li>
				</ul>
			...
			<nav
				...
				<div class="container-fluid">
					<div class="navbar-wrapper">
						...
						<a class="navbar-brand" href="${pageContext.request.contextPath}/a/oc">개설 과정 관리</a>
					</div>
						...
						<ul class="navbar-nav">
							<li class="nav-item btn-rotate dropdown"><a
								...
								<div class="dropdown-menu dropdown-menu-right"
									...
									<a class="dropdown-item" href="${pageContext.request.contextPath}/views/login/logout.jsp">로그아웃</a>
								</div></li>
						</ul>
					</div>
				</div>
								...
								<form class="form-inline">
									...
									<div>
										<button type="button" class="btn btn-neutral btn-lg"
											disabled="disabled">총 ${countOS}건</button>
									</div>
								</form>
							</div>
						</div>
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<form class="form-inline">
									...
									<div>
										<button type="button" class="btn btn-neutral btn-lg"
											disabled="disabled">총 ${countSt}건</button>
									</div>
								</form>
							</div>
						</div>
