...
<body>
   <div class="wrapper ">
            ...
            <ul class="nav">
               <li class="active">
					...
					<div class="in collapse show" id="basicinfo">
						<ul class="nav">
							<li>
								<a href="${pageContext.request.contextPath}/a/curriculum">
									<span class="sidebar-mini-icon">C</span>
									<span class="sidebar-normal"> 과정 관리</span>
								</a>
							</li>
							<li class="active">
								<a href="${pageContext.request.contextPath}/a/subject">
									<span class="sidebar-mini-icon">S</span>
									<span class="sidebar-normal"> 과목 관리</span>
								</a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/a/classroom">
									<span class="sidebar-mini-icon">R</span>
									<span class="sidebar-normal"> 강의실 관리</span>
								</a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/a/book">
									<span class="sidebar-mini-icon">B</span>
									<span class="sidebar-normal"> 교재 관리</span>
								</a>
							</li>
							</ul>
					</div>
				</li>
               <li><a href="${pageContext.request.contextPath}/a/instructor">
         ...
         <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
				<div class="container-fluid">
					<div class="navbar-wrapper">
						...
						<a class="navbar-brand" href="/a/subject">과목 관리</a>
					</div>
					...
					<div class="col-md-12">
						<div class="card">
							...
							<div class="card-header text-right">
								<div class="pull-left">
									<h4 class="card-title">과목 관리</h4>
								</div>
								<button type="button" class="btn btn-default btn-icon btnDel"
									data-toggle="modal" data-target="#addSubject" title="추가">
											...
											<tr>
												...
												<td>
													<button type="button" class="btn btn-default btn-icon btnUpdate"
														data-toggle="modal" data-target="#updateSubject" title="수정" value="${s.subject_id}">
														<i class="fa fa-pencil-square-o"></i>
													</button>
													<button type="button" class="btn btn-default btn-icon btnDel"
														data-target="#delSubject" data-toggle="modal" title="삭제" value="${s.subject_id}"
	...
	<div id="addSubject" class="modal fade" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="${pageContext.request.contextPath}/a/subject/add" method="post">
	...
	<!-- 과목삭제 -->
	<div id="delSubject" class="modal fade" role="dialog">
		<div class="modal-dialog">

			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">과목 삭제</h5>
				</div>
				<form action="${pageContext.request.contextPath}/a/subject/del" method="post">
					<div class="modal-body">
	...
	<div id="updateSubject" class="modal fade" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<form action="${pageContext.request.contextPath}/a/subject/update" method="post">
					<div class="modal-body">
						<div class="form-group">
							<label>과목번호</label>
							<input type="text" class="form-control subject_id" name="subject_id" readonly="readonly" required>
						</div>
						<div class="form-group">
							<label>과목명</label>
							<input type="text" class="form-control subject_name" name="subject_name" required>
						</div>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-default" data-dismiss="modal">CANCEL</button>
	...
	<script>
		$(document).ready(function() {
			...
			$(".btnUpdate").on("click", function(){
				...
				$("#updateSubject .subject_id").val(subject_id);
				$("#updateSubject .subject_name").val(subject_name);
			});
			$(".btnDel").on("click", function(){
				var subject_id = $(this).val();
				var subject_name = $(this).parents("td").siblings("td").eq(1).text();
				$("#delSubject .subject_id").val(subject_id);
	      		$("#delSubject #info").text(subject_id + " (" + subject_name + ")");
			});
		});
	</script>
</body>
