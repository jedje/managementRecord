	...
	<div class="wrapper ">
		<div class="sidebar" data-color="white" data-active-color="danger">
            ...
            <ul class="nav">
               ...
               <li class="active"><a href="${pageContext.request.contextPath}/a/profile"> <i
                     class="fa fa-gear"></i>
                     관리자 계정 관리
               </a></li>
            </ul>
			...
			<nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
				<div class="container-fluid">
					<div class="navbar-wrapper">
						...
						<a class="navbar-brand" href="">관리자 계정 관리</a>
					</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="card card-user">
							...
							<div class="card-body">
								<div class="author">
										<img class="avatar border-gray" src="${pageContext.request.contextPath}/resources/img/avatar.png">
								</div>
								<div class="row">
	...
	<div id="myModal" class="modal fade" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="${pageContext.request.contextPath}/a/profile/modify" method="post">
