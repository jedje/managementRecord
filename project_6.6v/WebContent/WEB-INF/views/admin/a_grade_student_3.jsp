									...
									<tbody>
										<c:forEach var="m" items="${info}">
											<tr>
												<td>${m.student_id}</td>
												<td>
													<a href="#" title="${m.student_name}" data-toggle="popover" data-placement="bottom" data-html="true"
													data-content='<img src="${pageContext.request.contextPath}/resources/img/mike.jpg">'>
													${m.student_name}</a> </td>
								...
								<form class="form-inline">
									...
									<div>
										<button type="button" class="btn btn-neutral btn-lg"
											disabled="disabled">총 ${gCount}건</button>
									</div>
								</form>
							</div>
						</div>
