				...
				<div class="row">
					<c:forEach var="m" items="${cList}">
						<div class="col-md-6">
							<div class="card">
								<div class="container">
									<h4 class="card-title">${m.room_name}</h4>
									<div class="stats">
										<p>${m.curriculum_name == null ? "진행중인 과정이 없습니다." : ""}${m.curriculum_name}</p>
										<i class="fa fa-calendar"></i>
										${m.oc_start_date} ~ ${m.oc_end_date}
									</div>
									<div class="progress" style="margin-bottom: 10px">
										<div class="progress-bar progress-bar-striped active"
											role="progressbar" aria-valuenow="60" aria-valuemin="0"
											aria-valuemax="100" style="width: ${m.progress}%">
											${m.progress}%</div>
									</div>
									<div class="stats">
										<i class="fa fa-users"></i>
										수강인원 / 중도탈락자 / 정원 : ${m.admissionCount - m.abandCount} / ${m.abandCount} / ${m.room_capacity}
									</div>
									<div class="progress" style="margin-bottom: 10px">
										<div class="progress-bar progress-bar-striped bg-info active"
											style="width: ${m.ingRate}%">${m.curriculum_name == null ? "" : "수료예정자"}</div>
										<div class="progress-bar bg-danger progress-bar-striped active"
											style="width: ${m.abandRate}%">${m.curriculum_name == null ? "" : "중도탈락자"}</div>
									</div>
								</div>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header text-right">
								...
								<a href="${pageContext.request.contextPath}/a/notice">
									<button type="button" class="btn btn-default btn-icon" title ="공지사항 관리">
										<i class="fa fa-cog"></i>
									</button></a>
							</div>
							<div class="card-body">
