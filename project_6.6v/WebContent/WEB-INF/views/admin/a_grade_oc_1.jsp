					...
					<div class="col-md-12">
						<div class="card">
							...
							<div class="card-body">
									...
									<tbody>
										<c:forEach var="m" items="${list}">
											<tr>
												...
												<td><a href="${pageContext.request.contextPath}/a/grade/oc/info?oc_id=${m.oc_id}">
								...
								<form class="form-inline" action="${pageContext.request.contextPath}/a/grade/oc" method="post">
